...
export default function LineMdSunnyFilledLoopToMoonFilledLoopTransition(props) {
    return (
        <svg
        ...
        >
            ...
            >
                <animate
                    ...
                    begin="1.2s;SVGiNMVtdZD.begin+12s"
                    dur="0.8s"
                    values="0;1"
                ></animate>
                <animate
            ...
            >
                <g>
                    ...
                    <set fill="freeze" attributeName="opacity" begin="1s" to={0}></set>
                </g>
                <path
                    fill="currentColor"
